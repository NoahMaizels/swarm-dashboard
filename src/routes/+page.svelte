...
<div> 
	<div class="bg-contain bg-no-repeat bg-orange-pattern bg-right-top ">
		<div class="px-6 py-64 sm:py-32 lg:px-8">
	...
	<div class="grid md:grid-cols-2 grid-cols-1">
		<div class="chart-container">
			<h2 class="text-orange-400 text-4xl text-center pb-6">Title</h2>
			<LayerCake
				padding={{ right: 16, bottom: 0, left: 16, top: 0 }}
				x={xKey}
				y={yKey}
				yDomain={[0, null]}
				data={points}
